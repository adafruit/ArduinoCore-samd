...
#define SERIAL1_HANDLER(i)  SERCOM0_##i##_Handler
...
#define SERIAL2_HANDLER(i)  SERCOM4_##i##_Handler
...
#define SERIAL3_HANDLER(i)  SERCOM1_##i##_Handler
...
#define SERIAL4_HANDLER(i)  SERCOM5_##i##_Handler
